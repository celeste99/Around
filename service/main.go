...
const (
	...
	POST_TYPE  = "post"
	DISTANCE   = "200km"
	ES_URL     = "http://35.237.61.34:9200"

	BUCKET_NAME     = "celeste-post-images"
...
func saveToBigTable(p *Post, id string) {
	...
	bt_client, err := bigtable.NewClient(ctx, "around-230218", "around-post", option.WithCredentialsFile("Around-688aa8fc5b15.json"))
	if err != nil {
		panic(err)
		return
	}
...
func saveToGCS(r io.Reader, bucketName, objectName string) (*storage.ObjectAttrs, error) {
	...
	// Creates a client.
	client, err := storage.NewClient(ctx, option.WithCredentialsFile("Around-688aa8fc5b15.json"))
	if err != nil {
		return nil, err
	}
